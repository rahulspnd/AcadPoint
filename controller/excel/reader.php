...
//		var_dump($res);		
  ...
  //      echo $pos ."<br>";
        ...
        while ($code != Spreadsheet_Excel_Reader_Type_EOF)
        {
            switch ($code)
            {
                case Spreadsheet_Excel_Reader_Type_SST:             //Extracts strings from excel sheet
                    //echo "Type_SST\n";
                     $spos = $pos + 4;
                     $limitpos = $spos + $length;
                     $uniqueStrings = $this->_GetInt4d($this->data, $spos+4);
                                  //    echo $uniqueStrings . "<br>";
                                                $spos += 8;
        ...
        // Read in the number of characters
                                                ...
                                                if ($spos == $limitpos)   // Reached the limit
                                                {
                                            ...
                                            //    echo "i = $i pos = $spos numChars = $numChars <br>";
                                                $spos += 2;
                                              ...
                                              //  echo "aa";
                                                ...
                                                if ($extendedString) {
                                                  $spos += $extendedRunLength;
                                                        ...
                                                        //      echo "bb\n";
                                                        //}
                                                $this->sst[]=$retstr;        // Stores all strings
                                           //     echo $retstr . "<br>";
                                       }
                ...
                case Spreadsheet_Excel_Reader_Type_NAME:
                    //echo "Type_NAME\n";
                    break;
                case Spreadsheet_Excel_Reader_Type_FORMAT:      //Format like color
                      ...
                      //  echo $formatString . "<br>";
                    $this->formatRecords[$indexCode] = $formatString;         // Stores all formatting
                   // echo "Type.FORMAT\n";
                    break;
                case Spreadsheet_Excel_Reader_Type_XF:
                     ...
                     //   echo $this->dateFormats[$indexCode] ."<br>" ;
                        }
                        elseif (array_key_exists($indexCode, $this->numberFormats))
                        {
                      //  echo "isnumber ".$this->numberFormats[$indexCode];

//                        $this->formatRecords['xfrecords']['type'] = 'number';
//                        $this->formatRecords['xfrecords']['format'] = $this->numberFormats[$indexCode];
                        $this->formatRecords['xfrecords'][] = array(
                                    'type' => 'number',
                             ...
                             //       echo "$indexCode <br>";
     /*           foreach($this->formatRecords  as $key => $val)
                {    echo $key . $val . "<br>";
                     if(is_array($val))
                ...
                //            echo $this->numberFormats[$indexCode] . "<br>" ;
                        }
                        else
                        {
                ...
                case Spreadsheet_Excel_Reader_Type_BOUNDSHEET:
                    ...
                    $this->boundsheets[] = array('name'=>$rec_name,
                                                 'offset'=>$rec_offset);        //Sheet name with offset
...
//            $r = &$this->file->nextRecord();
            ...
            if ($lowcode == Spreadsheet_Excel_Reader_Type_EOF)  //Empty sheet
                break;
            ...
            switch ($code)
            {
                case Spreadsheet_Excel_Reader_Type_DIMENSION:     // number of rows and columns
                    //echo 'Type_DIMENSION ';
                ...
                case Spreadsheet_Excel_Reader_Type_MERGEDCELLS:     //Cell merged
                  ...
                  //      echo "fr - $fr -- lr - $lr -- fc - $fc -- lc - $lc <br>";
                        if ($lr - $fr > 0) {
                ...
                /*        foreach( $this->createDate($numValue) as $key => $val)
                        {
                            echo "$key - $val <br>";
                        }
                  */
...
//                        echo "aa<br>";
    ...
    function isDate($spos)
    {
      ...
      //  echo $spos . "<br>";
        ...
        {
            //$xfindex = ord($this->data[$spos+6]) | ord($this->data[$spos+7]) << 8 ;
       //     $xfindex++;
      //      echo $this->formatRecords['xfrecords'][$xfindex]['type'] . "<br>";
      //        echo $xfindex . "<br>";
...
//         echo $this->curformat . "<br>" . $this->_defaultFormat . "<br>";
...
//end of changes by mmp		
    ...
    function _GetInt4d($data, $pos) {
     //   echo ord($data[$pos]) | (ord($data[$pos+1]) << 8) | (ord($data[$pos+2]) << 16) | (ord($data[$pos+3]) << 24);
     //   echo "<br>";
